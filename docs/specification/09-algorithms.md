...
<nav class="spec-pager">
  <a class="spec-pager__prev" href="{{ '/specification/08-moves.html' | relative_url }}">&larr; Moves</a>
  <a class="spec-pager__next" href="{{ '/specification/10-transformations.html' | relative_url }}">Transformations &rarr;</a>
</nav>
