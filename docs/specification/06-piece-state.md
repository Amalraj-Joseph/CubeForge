---
layout: page
title: Piece State · Specification
---
...
<nav class="spec-pager">
  <a class="spec-pager__prev" href="{{ '/specification/05-positions.html' | relative_url }}">&larr; Positions</a>
  <a class="spec-pager__next" href="{{ '/specification/07-cube-state.html' | relative_url }}">Cube State &rarr;</a>
</nav>
