...
<nav class="spec-pager">
  <a class="spec-pager__prev" href="{{ '/specification/12-compliance.html' | relative_url }}">&larr; Compliance</a>
  <a class="spec-pager__next" href="{{ '/specification/14-validity-and-parity.html' | relative_url }}">Validity & Parity &rarr;</a>
</nav>
