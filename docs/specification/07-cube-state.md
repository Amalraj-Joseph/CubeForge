---
layout: page
title: Cube State · Specification
---
...
<nav class="spec-pager">
  <a class="spec-pager__prev" href="{{ '/specification/06-piece-state.html' | relative_url }}">&larr; Piece State</a>
  <a class="spec-pager__next" href="{{ '/specification/08-moves.html' | relative_url }}">Moves &rarr;</a>
</nav>
