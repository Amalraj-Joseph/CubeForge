...
<nav class="spec-pager">
  <a class="spec-pager__prev" href="{{ '/specification/11-api.html' | relative_url }}">&larr; API</a>
  <a class="spec-pager__next" href="{{ '/specification/13-notation.html' | relative_url }}">Notation &rarr;</a>
</nav>
