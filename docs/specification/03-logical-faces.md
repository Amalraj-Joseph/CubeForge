---
layout: page
title: Logical Faces · Specification
---
...
<nav class="spec-pager">
  <a class="spec-pager__prev" href="{{ '/specification/02-pieces.html' | relative_url }}">&larr; Pieces</a>
  <a class="spec-pager__next" href="{{ '/specification/04-orientation.html' | relative_url }}">Orientation &rarr;</a>
</nav>
