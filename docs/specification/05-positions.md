...
<nav class="spec-pager">
  <a class="spec-pager__prev" href="{{ '/specification/04-orientation.html' | relative_url }}">&larr; Orientation</a>
  <a class="spec-pager__next" href="{{ '/specification/06-piece-state.html' | relative_url }}">Piece State &rarr;</a>
</nav>
